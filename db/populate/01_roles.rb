...
# users
User.create(email:"foliomedia2@yahoo.com", first_name: "Michael", last_name: "Hfuhruhurr", encrypted_password: "$2a$10$TwVWBd5ilT7kmwhXI3gMmuB1CfLOku/hGgQIne1avyKpA0Byzj496")
